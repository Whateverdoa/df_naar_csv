...
from summary import summary_splitter_df_2, html_sum_form_writer
...
while True:
    ...
    layout = [
        ...
        [sg.InputText('1', key='vdp_aantal'), sg.Text("VDP's", font=font)],
    ...
    while True:
        ...
        if event in ('Exit', None):
            ...
            if aantal_vdps == 1:
                wdir= name_file_in
                vdp_naam_csv =  pad.joinpath(f'{name_file_in.stem}_VDP_1.csv')
